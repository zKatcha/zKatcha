...
contract Relayer {
    ...
    function getZkVTRFProofVerificationResult(
        string calldata id
    ) external view returns (ZkVTRFProofVerificationResult memory entry) {
     ...
     */
    function publishProofVerification(
        string calldata id,
        address publisher,
    ...
    function _publishProofVerification(
        string calldata id,
        address publisher,
        string calldata proofIPFSHash,
        uint256 timestamp,
